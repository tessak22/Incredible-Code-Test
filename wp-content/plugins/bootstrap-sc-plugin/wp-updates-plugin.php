...
new WPUpdatesPluginUpdater_604( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_604') ) {
    class WPUpdatesPluginUpdater_604 {
